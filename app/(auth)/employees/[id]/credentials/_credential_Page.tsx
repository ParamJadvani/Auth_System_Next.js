...
export default function CredentialsPage({ id }: { id: number }) {
    ...
    const fetchData = useCallback(async () => {
        ...
        const res = await getCredentials(id, currentParams);
        ...
        setLoading(false);
    }, [getAllParams, getCredentials, applyFilters, id, getTags]);
    ...
    return (
        <div className="flex flex-col gap-6 p-4">
            ...
            <div className="border rounded-lg overflow-auto">
                <TableDisplay data={data} onDelete={deleteCredential} loading={loading} isEmp={id} />
            </div>
            <Pagination
                data={data?.meta}
