...
export function AdminForm({ data, editing, onSubmit }: AdminFormProps) {
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 bg-white rounded-lg shadow-xs p-4 sm:p-6 lg:p-8">
                <Card className={`shadow-none border-0 ${editing ? "border-b-2 border-gray-300 rounded-none pt-3 pb-6`" : "p-0 m-0"}`}>
                    <CardHeader className={`${editing ? "" : "p-0 m-0"}`}>
                        <CardTitle className="text-lg font-semibold">Basic Details</CardTitle>
                    </CardHeader>
                    <CardContent className={`flex flex-col justify-center space-y-8 ${editing ? "" : "m-0 p-0"}`}>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                            ...
                            {!editing && (
                                <FormControl>
                                    <PasswordInput id='password' label="Password" type="password" placeholder="Enter password" {...form.register("password")} className='w-full border px-3 py-2' />
                                </FormControl>
                            )}
                        </div>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                            ...
                            {/* Blood Group */}
                            <div className="space-y-2">
                                <Label className="font-medium text-sm text-black ml-2">Blood Group</Label>
                                <div className='relative'>
                                    <Select
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 ml-2">
                            {/* Contributions */}
                    ...
                    <>
                        <Card className='border-0 shadow-none border-b-2 border-gray-300 rounded-none pt-3 pb-6'>
                            ...
                            <CardContent className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 pt-2 items-center">
                                ...
                                <FormControl>
                                    <IconInput id='city' label="City" placeholder="Enter city" {...form.register("city")} className='w-full border px-3 py-2' />
                                </FormControl>
                                <FormControl>
                        ...
                        <Card className='border-0 shadow-none border-b-2 border-gray-300 rounded-none pt-3 pb-6'>
                            ...
                            <CardContent className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 pt-2 items-center">
                                ...
                                <div className='space-y-2'>
                                    <Label className="text-sm font-medium text-black ml-2">Account Type</Label>
                                    <div className='relative'>
                                        <Select
