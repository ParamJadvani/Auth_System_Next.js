...
import { EmployeesResponse, IEmployeeValues } from '@/types/employees';
...
export function EmployeesTable({ data, loading, onDelete }: EmployeesTableProps) {
    return (
        <Card className="bg-white rounded-lg overflow-hidden p-0 shadow-sm">
            <DRYTable<IEmployeeValues[]>
                loading={loading}
                headerColumn={[
